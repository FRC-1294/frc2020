...
public class OI {
  ...
  public double getTriggerLeft() {
    return (gameShootingArm.getTriggerAxis(Hand.kLeft));
  }
  /*public double LeftTrigger(){
    return driveControl.getTriggerAxis(Hand.kLeft);
  }
  public double RightTrigger(){
    return driveControl.getTriggerAxis(Hand.kRight);
  }
  public boolean Abutton(){
    return driveControl.getAButtonPressed();
  }
  public boolean Ybutton(){
    return driveControl.getYButtonPressed();
  }
  public double driveLeftX(){
    return driveControl.getX(Hand.kLeft);
  }
  public double driveLeftY(){
    return driveControl.getY(Hand.kLeft);
  }
